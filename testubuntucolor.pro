...
UBUNTU_TRANSLATION_DOMAIN="testubuntucolor.liu-xiao-guo"
...
aptest.commands = bash $$PWD/testubuntucolor/tests/autopilot/run
aptest.depends  = sub-testubuntucolor

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/testubuntucolor/tests/unit
unittest.depends  = sub-testubuntucolor
